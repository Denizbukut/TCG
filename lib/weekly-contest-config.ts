...
export const WEEKLY_CONTEST_CONFIG = {
  ...
  contestEnd: "2026-03-31T21:59:59Z",
  
  // Prize Pool Configuration
  prizePool: [
    { rank: "1st Place", reward: "100 WLD + 200 Legendary Tickets", icon: "🥇" },
    { rank: "2nd Place", reward: "50 WLD + 150 Legendary Tickets", icon: "🥈" },
    { rank: "3rd Place", reward: "35 WLD + 100 Legendary Tickets", icon: "🥉" },
    { rank: "4th–6th Place", reward: "20 WLD + 50 Regular Tickets", icon: "🎖️" },
