...
export const WEEKLY_CONTEST_CONFIG = {
  ...
  contestEnd: "2026-03-18T20:59:59Z",
  
  // Prize Pool Configuration
  prizePool: [
    { rank: "1st Place", reward: "150 WLD + 500 Legendary Tickets", icon: "🥇" },
    { rank: "2nd Place", reward: "75 WLD + 350 Legendary Tickets", icon: "🥈" },
    { rank: "3rd Place", reward: "50 WLD + 200 Legendary Tickets", icon: "🥉" },
