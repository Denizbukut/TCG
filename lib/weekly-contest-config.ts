...
export const WEEKLY_CONTEST_CONFIG = {
  ...
  contestEnd: "2026-02-14T20:59:59Z",
  
  // Prize Pool Configuration
  prizePool: [
    { rank: "1st Place", reward: "200 WLD + 1000 Legendary Tickets", icon: "🥇" },
    { rank: "2nd Place", reward: "100 WLD + 500 Legendary Tickets", icon: "🥈" },
    { rank: "3rd Place", reward: "50 WLD + 250 Legendary Tickets", icon: "🥉" },
    { rank: "4th–6th Place", reward: "25 WLD + 150 Regular Tickets", icon: "🎖️" },
