            ...
            <div className="text-sm text-yellow-100 space-y-1">
              ...
              <Collapsible className="w-full" open={isWheelSpinsOpen} onOpenChange={setIsWheelSpinsOpen}>
                ...
                <CollapsibleContent className="pt-1 space-y-1 text-xs pl-0 text-left">
                  ...
                  <div className="text-left">• {t("contest.premium_wheel", "Premium Lucky Wheel Spin")} = <span className="font-bold text-yellow-400">18 {t("contest.points", "Points")}</span></div>
                </CollapsibleContent>
              </Collapsible>
              <Collapsible className="w-full" open={isOtherOpen} onOpenChange={setIsOtherOpen}>
                ...
                <CollapsibleContent className="pt-1 space-y-1 text-xs pl-0 text-left">
                  ...
                  <div className="text-left">• {t("contest.special_deal", "Buying Special Deal")} = <span className="font-bold text-yellow-400">50 {t("contest.points", "Points")}</span></div>
                </CollapsibleContent>
              </Collapsible>
            </div>
