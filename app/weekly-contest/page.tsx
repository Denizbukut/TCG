            ...
            <div className="text-sm text-yellow-100 space-y-1">
              <Collapsible className="w-full" open={isDrawCardsOpen} onOpenChange={setIsDrawCardsOpen}>
                ...
                <CollapsibleContent className="pt-1 space-y-1 text-xs pl-0 text-left">
                  ...
                  <div className="text-left">• {t("contest.epic_cards", "Epic Cards")} = <span className="font-bold text-yellow-400">15 {t("contest.points", "Points")}</span> <span className="text-green-400 font-bold">(3x Bonus)</span></div>
